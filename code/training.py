# %%
"""
#### This is used to train a character recongition from input image using MobileNets 
"""
...
# %%
dataset_paths = glob.glob("CharClass/**/*.png")
...
plt.savefig("output/Visualize_dataset.jpg",dpi=300)    
...
# %%
# data augumentation
image_gen = ImageDataGenerator(rotation_range=2,
